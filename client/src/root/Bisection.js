...
class Bisection extends Component{
    ...
    componentDidMount()
    {
        axios.get('http://localhost:8080/Dbisection.php') //docker//
        //axios.get("http://localhost/Webnumer/server/Dbisection.php")
        .then(res=>{
        ...
        return(
                ...
                <div>
                    ...
                    <div className ="sidebar row col-md-8">
                        ...
                        <br />
                        <br />
                        <input type="submit" value="Submit" onClick={this.bisectioncal}/>
                        <br />
